 ...
 */
  ...
  #elif REDUNDANT_TEMP_MATCH(TARGET, COOLER2) && !PIN_EXISTS(TEMP_COOLER2)
    #error "TEMP_SENSOR_REDUNDANT_TARGET can't be COOLER2 without TEMP_COOLER2_PIN defined."
  #endif
 ...
 */
  ...
  #error "TEMP_SENSOR_CHAMBER requires TEMP_CHAMBER_PIN."
    ...
    #error "TEMP_SENSOR_COOLER requires TEMP_COOLER_PIN." //TEMP_COOLER_FAN_PIN

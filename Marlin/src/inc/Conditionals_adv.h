...
#define ANY_THERMISTOR_IS(N) (0 REPEAT2(HOTENDS, _E_SENSOR_IS, N) \
  ...
  _SENSOR_IS(N,COOLER) _SENSOR_IS(N,COOLER2) _SENSOR_IS(N,BOARD) _SENSOR_IS(N,REDUNDANT) )
...
#if TEMP_SENSOR_COOLER2 == -4
  #define TEMP_SENSOR_COOLER_IS_AD8495 1
#elif TEMP_SENSOR_COOLER2 == -3
  #error "MAX31855 Thermocouples (-3) not supported for TEMP_SENSOR_COOLER2."
#elif TEMP_SENSOR_COOLER2 == -2
  #error "MAX6675 Thermocouples (-2) not supported for TEMP_SENSOR_COOLER2."
#elif TEMP_SENSOR_COOLER2 == -1
  #define TEMP_SENSOR_COOLER_IS_AD595 1
#elif TEMP_SENSOR_COOLER2 > 0
  #define TEMP_SENSOR_COOLER2_IS_THERMISTOR 1
  #if TEMP_SENSOR_COOLER2 == 1000
    #define TEMP_SENSOR_COOLER_IS_CUSTOM 1
  #elif TEMP_SENSOR_COOLER2 == 998 || TEMP_SENSOR_COOLER2 == 999
    #define TEMP_SENSOR_COOLER_IS_DUMMY 1
  #endif
#else
  #undef THERMAL_PROTECTION_COOLER2
  #undef COOLER2_MINTEMP
  #undef COOLER2_MAXTEMP
#endif

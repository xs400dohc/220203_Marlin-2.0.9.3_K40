...
#if TEMP_SENSOR_COOLER > 0  //TEMP_SENSOR_COOLER_FAN
...
#if TEMP_SENSOR_COOLER2 > 0  //TEMP_SENSOR_COOLER_FAN
  #define TEMPTABLE_COOLER2 TT_NAME(TEMP_SENSOR_COOLER2)
  #define TEMPTABLE_COOLER2_LEN COUNT(TEMPTABLE_COOLER2)
#else
  #define TEMPTABLE_COOLER2_LEN 0
#endif
...
#define TT_REVRAW(N)  (TT_REV(N) || _TT_REVRAW(N))
  ...
  #endif
#endif
#ifndef TEMP_SENSOR_COOLER2_RAW_HI_TEMP
  #if TT_REVRAW(COOLER2)
    #define TEMP_SENSOR_COOLER2_RAW_HI_TEMP MAX_RAW_THERMISTOR_VALUE
    #define TEMP_SENSOR_COOLER2_RAW_LO_TEMP 0
  #else
    #define TEMP_SENSOR_COOLER2_RAW_HI_TEMP 0
    #define TEMP_SENSOR_COOLER2_RAW_LO_TEMP MAX_RAW_THERMISTOR_VALUE
  #endif
#endif

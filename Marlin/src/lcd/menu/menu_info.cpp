...
void menu_info_thermistors() {
  ...
  #if HAS_COOLER2
    #undef THERMISTOR_ID
    #define THERMISTOR_ID TEMP_SENSOR_COOLER2
    #include "../thermistornames.h"
    STATIC_ITEM_P(PSTR("COOL: " THERMISTOR_NAME), SS_INVERT);
    PSTRING_ITEM(MSG_INFO_MIN_TEMP, STRINGIFY(COOLER2_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFO_MAX_TEMP, STRINGIFY(COOLER2_MAXTEMP), SS_LEFT);
    STATIC_ITEM(TERN(WATCH_COOLER2, MSG_INFO_RUNAWAY_ON, MSG_INFO_RUNAWAY_OFF), SS_LEFT);
  #endif
